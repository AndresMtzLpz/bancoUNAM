...
--
-- Volcado de datos para la tabla `datosAdmin`
--
...
--
-- Estructura de tabla para la tabla `prestamo_cliente`
--
...
--
-- Volcado de datos para la tabla `prestamo_cliente`
--
...
--
-- Filtros para la tabla `accesoAdmin`
--
ALTER TABLE `accesoAdmin`
